...
class CfgMods
{
	class HelicopterModSIB_black_hawk_new1
	{
		dir="\MOD\HelicopterSIB_black-hawk_new1";
		hideName=0;
		hidePicture=0;
		...
		class defs
		{
			class worldScriptModule
			{
				...
				files[]=
				{
					"\MOD\HelicopterSIB_black-hawk_new1/4_World/"
				};
			};
			class gameScriptModule
			{
				...
				files[]=
				{
					"\MOD\HelicopterSIB_black-hawk_new1/3_Game/"
				};
			};
			class missionScriptModule
			{
				...
				files[]=
				{
					"\MOD\HelicopterSIB_black-hawk_new1/5_Mission/"
				};
			};
		};
	};
...
class CfgVehicles
{
	...
	class SIBblack_hawk_Door_1_1_new1: SIBblack_hawk_Door_1_1
	{
		...
		hiddenSelectionsTextures[] ={"\MOD\HelicopterSIB_black-hawk_new1\data\11_new1.paa"};
	};
	...
	class Heliblack_hawk_SIB_new1: Heliblack_hawk_SIB
	{
		...
		hiddenSelectionsTextures[] ={"\MOD\HelicopterSIB_black-hawk_new1\data\hawk_new1.paa","\MOD\HelicopterSIB_black-hawk_new1\data\8_new1.paa","\MOD\HelicopterSIB_black-hawk_new1\data\11_new1.paa","\MOD\HelicopterSIB_black-hawk_new1\data\28_new1.paa"};
		class Cargo 
		{
