	...
	class HelicopterModhommade_new1
	{
		...
		class defs
		{
			class worldScriptModule
			{
				...
				files[]=
				{
					"\MOD\HelicopterSIB_Hommade_new11/4_World/"
				};
			};
			class gameScriptModule
			{
				...
				files[]=
				{
					"\MOD\HelicopterSIB_Hommade_new11/3_Game/"
				};
			};
			class missionScriptModule
			{
				...
				files[]=
				{
					"\MOD\HelicopterSIB_Hommade_new11/5_Mission/"
				};
			};
		};
	};
...
class CfgVehicles
{
	...
	class HeliSIB_hommade_new1: HeliSIB_hommade
	{
		...
		hiddenSelectionsTextures[] ={"\MOD\HelicopterSIB_Hommade_new11\data\light_helicopter_main_new1.paa"};
		class Cargo 
		{
